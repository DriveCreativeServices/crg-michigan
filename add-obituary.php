...
<head>
    ...
    <title>Add Obituary | CRG Michigan - Connecting and Supporting Michigan Small Business</title>
    ...
    <main>
        ...
        <section>
            <div class="container" style="padding: 50px 50px;">
                <h2 style="padding-bottom: 25px;">Add a Obituary</h2>
                <form method="post" action="scripts/add-obituary.php" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-6">
                ...
                <button type="submit" class="btn btn-primary" name="submit">Add Listing</button>
                </form>
            </div>
        </section>
        <!-- Add a article END-->
