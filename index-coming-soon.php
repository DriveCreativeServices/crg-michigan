                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-9 col-lg-11">
                            ...
                            <div class="hero-caption pt-10">
                                ...
                                <h1>Coming Soon</h1>
                                <p>Explore your neighborhood's products & services, local happenings<br> dining & entertainment, places of interest and much more.</p>
                            </div>
                            <!--Hero form -->
                            ...
                            <div class="category-items text-center">
                                <ul>
                                    <li><a href="coming-soon-registration.php" style="width: 300px;">Register your business</a></li>
