     ...
     <div class="blog_details">
      ...
      <ul class="blog-info-link mt-3 mb-4">
        <li><a href="#"><i class="fa fa-city"></i>
          <?php 
              echo "".$cityDetails['city_name']." |  <i class='fa fa-clock'></i> ".$eventDate."</a>";
              ?>
        </li>
      </ul>
      <div class="excert">
...
<div class="navigation-top">
  <div class="d-sm-flex justify-content-between text-center">
   <div class="col-sm-4 text-center my-2 my-sm-0">
    ...
    <li><a href="http://twitter.com/share?url=http://www.crgmichigan.com/listing.php?id=<?php echo $eventId?>&text=Check out this local listing from CRG Michigan: <?php echo $title?>&hashtags=CRGMichigan,ConnectingMichigan,SmallBusiness" target="_blank"><i class="fab fa-twitter"></i></a></li>
  </ul>
</div>
</div>
</div>
...
<div class="col-lg-4">
 <div class="blog_right_sidebar">
    <?php 
        if($eventDetails['event_approved'] == 0){
            echo '<h4 style="color: red;">Waiting for Approval</h4>';
        }
    ?>
    <aside class="single_sidebar_widget popular_post_widget">
      <h3 class="widget_title" style="color: #2d2d2d;">Other Events</h3>
      <?php

            $eventsq = mysqli_query($con, "SELECT * FROM `event` WHERE `city_id` = '$cityId' && `event_approved` = 1 ORDER BY `timestamp` DESC");
