...
<head>
    ...
    <title>Add Listing | CRG Michigan - Connecting and Supporting Michigan Small Business</title>
    ...
    <main>
        ...
        <section>
            <div class="container" style="padding: 50px 50px;">
                <h2 style="padding-bottom: 25px;">Add a Listing</h2>
                <form method="post" action="scripts/add-listing.php" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-6">
